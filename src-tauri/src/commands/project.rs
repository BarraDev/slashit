...
mod tests {
    ...
    async fn attach_project_to_workspace_committed_attaches_a_standalone_project() {
        ...
        let result = attach_project_to_workspace_committed(&projects, &storage, id, workspace_id)
            .await
    ...
    async fn attach_project_to_workspace_committed_refuses_a_project_already_in_a_workspace() {
        ...
        let result =
            attach_project_to_workspace_committed(&projects, &storage, id, Uuid::new_v4()).await;
    ...
    async fn attach_project_to_workspace_committed_refuses_a_missing_project() {
        ...
        let result =
            attach_project_to_workspace_committed(&projects, &storage, Uuid::new_v4(), Uuid::new_v4())
                .await;
